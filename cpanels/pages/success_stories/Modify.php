                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 '>
                                                    ...
                                                    <div class="input-group margin">
                                                        <textarea class="form-control custom-control" rows="10" style="resize:none" name="comment"><?php echo $comment; ?></textarea>     
                                                    ...
                                                    <span class="control-fileupload">
                                                        <label for="file">Choose a file :<?php echo $Image; ?></label>
                                                        <input type="file" id="uploadFile" name="uploadFile">
                                                    </span>  
                                                    <input type="submit" class="btn btn-info btn-block btn-lg margin btn" value="تعديل الموضوع">
                                                                                                                                                <img src="../../../Public/success_stories/<?php echo $Image; ?>" class=" img-responsive img-thumbnail" width="150"  >
