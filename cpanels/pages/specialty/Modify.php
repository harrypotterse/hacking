                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 '>
                                                    ...
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Specialty" value="<?php echo  $Specialty ; ?>">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">القسم</button>
                                                        </span>
                                                    </div>
                                                    <div class="input-group margin">
                                                        <select  class="form-control input-lg" id="sel1" name="Icon">
                                                            <?php
                                                            $query = "select * from  icons ORDER BY `icons`.`id` DESC ;";
                                                            $array = array();
                                                            $rows = $class->sql_feth($Data_communication, $query, $array);
                                                            if (count($rows) > 0) :
                                                                foreach ($rows as $value):
