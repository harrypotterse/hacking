    ...
    <body class="skin-blue sidebar-mini">
                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 form '>
                                                    ...
                                                    <div class="form-group margin">
                                                        ...
                                                        <textarea class="form-control" rows="5" id="textarea"  class="textarea" name="Subject" placeholder="مواعيد العمل"></textarea>
                                                    </div>
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="story_id[]">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg story" type="button">رابط يوتيوب</button>
                                                        </span>
                                                    </div>
                                                    <div id="form">
                                                    </div>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                $('.story').on('click', function (x) {

                    var textMore = "<div class=\"input-group margin\">\n" +
                            "                                                        <input type=\"text\" class=\"form-control input-lg\" name=\"story_id[]\">\n" +
                            "                                                        <span class=\"input-group-btn \">\n" +
                            "                                                            <button class=\"btn btn-info btn-flat btn-lg Features\" type=\"button\">رابط يوتيوب</button>\n" +
                            "                                                        </span>\n" +
                            "                                                    </div>";
