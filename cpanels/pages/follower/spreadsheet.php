                                                    ...
                                                    <tr>
                                                        ...
                                                        if (count($rows) > 0) :
                                                            foreach ($rows as $value):
                                                                ...
                                                                <td><iframe width="300" height="300" src="<?php echo $url; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
                                                                <td><?php echo $Subtitle; ?></td>
                                                                <td><?php echo $Title; ?></td>
                                                                <td><img src="<?php echo $pic1; ?>" class="<?php echo classcss; ?>" width="<?php echo width; ?>" alt="Cinque Terre"></td>
