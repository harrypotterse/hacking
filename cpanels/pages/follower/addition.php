    ...
    <body class="skin-blue sidebar-mini">
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <form action="phpajax/add.php" id="uploadImage" method="post" enctype="multipart/form-data">
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 form '>

                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="YouTube">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">رابط اليوتيوب</button>
                                                        </span>
                                                    </div> 
                                                    <div class="input-group margin">
                                                        ...
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">العنوان الفرعي</button>
                                                        </span>
                                                    </div> 
                                               
                                                   <div class="form-group margin">
                                                        <button class="btn btn-info btn-flat btn-block" type="button">الموضوع</button>
                                                        <textarea class="form-control" rows="5" id="textarea"  class="textarea" name="Explanation" placeholder="مواعيد العمل"></textarea>
                                                    </div>

                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Download">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">رابط التطبيق </button>
                                                        </span>
                                                    </div> 
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="pic1">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">الصورة</button>
                                                        </span>
                                                           <span class="input-group-btn ">
                                                               <a class="btn btn-success btn-flat btn-lg" type="button" href="https://imggmi.com/" target="blank">رابط</a>
                                                        </span>
                                                    </div> 
                                                    
                                                    
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="pic2">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">الصورة</button>
                                                        </span>
                                                              <span class="input-group-btn ">
                                                      ...
                                                      <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Features[]">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg Features" type="button">المميزات</button>
                                                        </span>
                                                    </div>
                                                    <div id="form">
        ...
        <script type="text/javascript">
            ...
            jQuery(document).ready(function ($) {
                $('.Features').on('click', function (x) {
                    var textMore = "<div class=\"input-group margin\">\n" +
"                                                        <input type=\"text\" class=\"form-control input-lg\" name=\"Features[]\">\n" +
"                                                        <span class=\"input-group-btn \">\n" +
"                                                            <button class=\"btn btn-info btn-flat btn-lg Features\" type=\"button\">المميزات</button>\n" +
"                                                        </span>\n" +
"                                                    </div>";
                    $("#form").append(textMore);
                });
