                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 '>
                                                    ...
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="YouTube" value="<?php echo $YouTube; ?>">
                                                        <span class="input-group-btn ">
                                                    ...
                                                    <div class="input-group margin">
                                                        ...
                                                        <input type="text" class="form-control input-lg" name="Subtitle" value="<?php echo $Subtitle; ?>">
                                                        <span class="input-group-btn ">
                                                    ...
                                                    <div class="form-group margin">
                                                        ...
                                                        <textarea class="form-control" rows="5" id="textarea"  class="textarea" name="Explanation" placeholder="مواعيد العمل">
                                                            <?php echo $Explanation; ?>
                                                        </textarea>
                                                    </div>

                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Download" value=" <?php echo $Download; ?>">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">رابط التطبيق </button>
                                                        </span>
                                                    </div> 
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="pic1" value=" <?php echo $pic1; ?>">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">الصورة</button>
                                                        </span>
                                                        <span class="input-group-btn ">
                                                            <a class="btn btn-success btn-flat btn-lg" type="button" href="https://imggmi.com/">رابط</a>
                                                        </span>
                                                    </div> 


                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="pic2" value="<?php echo $pic2; ?>">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">الصورة</button>
                                                        </span>
                                                        <span class="input-group-btn ">
