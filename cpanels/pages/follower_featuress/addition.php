                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 form '>
                                                    ...
                                                    <div class="input-group margin">
                                                        <select class="form-control input-lg" id="sel1"     name="follower_id" >
                                                            <?php
                                    $query = "select * from  follower ORDER BY `follower`.`id` DESC ";
                                    $array = array();
                                    ...
                                    ?>
                                                    ...
                                                    <input type="submit" class="btn btn-info btn-block btn-lg margin btn" value=" اضافة ميزة جديدة">
                                                </div>
                                            </div>
