...
<?php
$class = new Achieve();
$query = "select * from  application_videos  where id = ? ";
$array_var = array();
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    ?>
                                               <option  <?php $id_app == $id ? ' selected="selected"' : ''; ?> value="<?php echo  $id ; ?>"><?php echo $Title; ?></option>                                                            <?php
                                        endforeach;
                                    endif;                      
                                    ?>
                                                        </select>
                                                    ...
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Video" value="<?php echo  $Video ; ?>">
                                                        <span class="input-group-btn ">
