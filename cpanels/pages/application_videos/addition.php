                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 form '>
                                                    ...
                                                    <div class="input-group margin">
                                                        <select class="form-control input-lg" id="sel1"     name="id_app" >
                                                            <?php
                                    ...
                                    ?>
                                                    ...
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Video">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">الفديو</button>
                                                        </span>
                                                    </div>
