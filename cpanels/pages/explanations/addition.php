                                ...
                                <div class="box">
                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 form '>
                                                    ...
                                                    <div class="input-group margin">
                                                        <select class="form-control input-lg" id="sel1"     name="Department" >
                                                            <?php
                                    ...
                                    ?>                                            
                                                        ...
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">Department</button>
                                                        </span>
                                                    </div>
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Link">
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">الرابط</button>
                                                        </span>
                                                    </div>
