...
<?php
$class = new Achieve();
$query = "select * from  explanations  where id = ? ";
$array_var = array();
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    ?>
                                                            <option  <?= $Department == $id ? ' selected="selected"' : ''; ?> value="<?php echo  $id ; ?>"><?php echo $name; ?></option>
                                                            <?php
                                       endforeach;
                                    endif;                       
                                    ?>                                            
                                                    ...
                                                    <div class="input-group margin">
                                                        <input type="text" class="form-control input-lg" name="Link" value="<?php echo  $Link ; ?>">
                                                        <span class="input-group-btn ">
