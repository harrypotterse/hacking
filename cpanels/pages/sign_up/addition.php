                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 '>
                                                    ...
                                                    <div class="form-group margin">
                                                        ...
                                                        <textarea class="form-control" rows="5" id="textarea"  class="textarea" name="Subject" placeholder=" "></textarea>
                                                    </div>
                                                    <input type="submit" class="btn btn-info btn-block btn-lg margin btn" value="ارسال الرسالة">
                                                </div>
                                            </div>
