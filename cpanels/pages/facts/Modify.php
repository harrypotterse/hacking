                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <form action="phpajax/edit.php" id="uploadImage" method="post">
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 '>
                                                    ...
                                                    <div class="input-group margin">
                                                        <select class="form-control input-lg" id="sel1"     name="story_id" >
                                                            <?php
                                        $query = "select * from  story ORDER BY `story`.`id` DESC;";
                                        $array = array();
                                        $rows = $class->sql_feth($Data_communication, $query, $array);
                                        if (count($rows) > 0) :
                                            foreach ($rows as $value):
                                                ...
                                                ?>
                                                        ...
                                                        <span class="input-group-btn ">
                                                            <button class="btn btn-info btn-flat btn-lg" type="button">قصة اليوم</button>
                                                        </span>
                                                    </div>
                                                    <div class="input-group margin">
                                        ...
                                        <div class="" style="    float: right;">
                                            <iframe width="560" height="315" src="<?php echo $url; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></iframe>
